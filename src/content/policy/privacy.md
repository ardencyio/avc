...
![Privacy policy](/img/vectors/private-data.svg)
...
Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the [ico.org.uk](https://ico.org.uk/for-the-public/online/cookies) website.) website.
